...
fn test_undo_at_block_boundary() {
    ...
    App::test((), |mut app| async move {
        ...
        state.assert_rendered(
            ...
            r#"
-------- 0.00px / 0 characters --------
Task List @ 1 [X] (2 characters, 1 lines, 20.00px tall)
-------- 20.00px / 2 characters --------
Task List @ 1 [ ] (2 characters, 1 lines, 20.00px tall)
-------- 40.00px / 4 characters --------
...
Task List @ 1 [ ] (2 characters, 1 lines, 20.00px tall)
-------- 56.00px / 6 characters --------
Task List @ 1 [ ] (2 characters, 1 lines, 20.00px tall)
-------- 76.00px / 8 characters --------
Trailing Newline (1 characters, 1 lines, 32.00px tall)
        "#,
        )
    });
